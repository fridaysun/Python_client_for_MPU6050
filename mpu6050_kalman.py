...
def animate(i):
    ...
    for index in range(0,18):
        ...
        #print len(timepcs)
        ax.append(float(element[1]))
        ay.append(float(element[2]))
        az.append(float(element[3]))
        gx.append(float(element[4]))
        gy.append(float(element[5]))
        gz.append(float(element[6]))
